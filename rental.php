...
<body>
	<header>
		...
		<div class="head">
			...
			<br>
			<font> offers to make it easy for clients to get the right car at right price at the right time.
			</font>
		</div>
	</header>
	<br><br><br>
	...
	<div class="break"><img src="images/rental.jpg" height="auto" width="80%" align="left" style="margin-left:50px;">
	</div>
	<script>
	...
	<aside class="ccr">
		...
		<p class="main" style="margin:2% 8% 0 48%;"> Rental wheels offers to make it easy for clients to get the right
			car at the right price at the right time.<br><br>
			If you are looking for car rental service in Delhi/India or minibusses hire services, then our company is
			the right option for you.<br><br>
			...
			Rental wheels has the large fleet of well-maintained cars and tempo traveler<br><br>
	...
	<aside class="ccr1">
		<div class="break">&emsp;&emsp;&emsp;&emsp;&emsp;</div>
		<h1>CAR AND COACHES RENTAL</h1>
		<p class="main"> Rental wheels offers to make it easy for clients to get the right car at the right price at the
			right time.<br><br>
			If you are looking for car rental service in Delhi/India or minibusses hire services, then our company is
			the right option for you.<br><br>
			Get the best deal on booking of luxury car and coaches in Delhi.<br><br>
	...
	<p class="main" style="color:black">
		...
		Going to a huge business customer Hosting an Important gathering Or on the other hand basically an airplane
		terminal exchange,
		Rental wheels driver drive administration can have any kind of effect when a distinction is required!

	</p><br>
	<p class="main" style="color:black">
		<b>Advantages</b><br>
	<ul style="list-style: circle;margin-left:30px;">
		<li style="display:list-item;">Professional English-talking driver who will meet and escort you to the auto
			without issue</li><br>
		<li style="display:list-item;;">High-Quality extravagance aerated and cooled and non-smoking vehicles</li><br>
		<li style="display:list-item;;">Flexible rental bundles accessible for air terminal/lodging exchange, Point A to
			B exchanges,
	...
	<p class="main" style="color:black">
		...
		The driver will meet you at the airplane terminal, office, eatery, inn or home. There is no compelling reason to
		design your excursion.
		Wherever you need to go…. You are in control!
	</p><br>
	<p class="main" style="color:black">
		<b>Singular rentals</b><br><br>
		As esteem included administration, we will monitor your inclinations when you get our escort drive benefits all
		the time. Your customary courses will be put away in our database so we can repeat your booking rapidly. We will
		likewise you educated you on any new items and administrations to make your movement life a great deal less
		demanding.
		<br><br><br>
		Corporate rentals
		<br><br>
		Rental wheels can give exceptional rates and rebates to normal customers.
		<br><br>
		Contact
		<br><br><b>
			Phone Number:<font color="#00afe5"> +91</font> 12455
			<br><br>
	...
	<footer>
		...
		<table>
			...
			<tr bgcolor="#252525">
				<td class="widget">
					<p class="text">rental is one of the reputed Travel<br>
						Company in India.At rental<br>
						everything we do is about giving you the<br>
						freedom to discover more.</p>
				</td>
				<td class="widget">
					<p class="text1">Address: Tamil Nadu,India<br>
						<img src="images/phone.png">&emsp;+91-123456789<br>
