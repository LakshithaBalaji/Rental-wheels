...
<body>
	<header>
		<div class="up" id="up">
			<div class="logo"><img src="images/lgo.jpeg" height="100%" width="10%%"
				...
				<font style="font-size:1.254vw;">&ensp;+91-123&emsp;</font>
				<img height="21%" width="1.9%" src="images/message.png" style="height:auto;">
				<font style="font-size:1.254vw;">&ensp;Info@rental.in</font>
			</div>
			<div class="logo1">
		...
		<div class="head">
			...
			<br>
			<font>very customer friendly company where customer service and satisfaction come first.</font>
		</div>
	</header>
	<br><br><br>
	...
	<div class="break"> <img src="images/self.jpg" height="auto" width="80%" align="left" style="margin-left:10%;"><br>
	</div>
	<script>
	...
	<div class="ccr">
		...
		<p class="main" style="margin:2% 5% 0 55%;line-height:2;">
			very customer friendly company where customer service and satisfaction come first.<br>
			we provide self-driven cars to customers at very convenient prices and gives absolutely new and young
			well-maintained fleet for hassle-free and memorable driving experience.<br>
			We are available 24×7 with highly professional and experienced customer care executives. They will guide you
			exactly
			accordingly to your need.<br>
		</p><br><br>
		<p class="main" style="color:black">
			<b>Wheelzonrent provides selfdriven car in Delhi/NCR India. Selfdriven concept has been highly developed in
				India as it quite new concept as well.</b><br><br>
			...
			Driving in India should be a safe and enjoyable experience. If you have never driven in India before you
			should become familiar with the rules of our roads.
			The Indian Transport Agency has issued some key driving tips which you should read before setting on your
			journey.<br><br>
			But first, as you will appreciate when you arrive in India – you’ve come a long way!!strongly suggest if you
			have come on a
			long haul flight, you stay overnight at your initial destination. That way, you’ll be nice and refreshed the
			next day to begin your journey.<br><br>
		</p>
		<p class="main" style="color:black">
		...
		<p class="main" style="color:black">
			...
			By law, everyone in the vehicle must wear a safety belt or child restraint – whether they’re in the front or
			back.
			Children under five years of age must be secured in an approved child restraint.<br><br>
			<b>Driving Speeds</b><br><br>
			Speed limit signs show the maximum speed you can travel. At times you may need to drive at a slower speed
			due to road, weather or traffic conditions.<br>
		<ul style="list-style: circle;">
			<li style="display:list-item;">On most of New Zealand’s main rural roads, the speed limit is 100km/h unless
				a sign says a lower speed applies.</li>
			<li style="display:list-item;">The speed limit is generally 100km/h on motorways.</li>
			<li style="display:list-item;">This sign indicates the default rural speed limit of 100km/h applies but the
				road is unlikely to be suitable to travel at that speed. You may need to drive at a slower speed</li>
			<li style="display:list-item;">In urban areas, the speed limit is usually 50km/h unless a sign says
				otherwise.</li>
		</ul>
		</p><br><br>
		<p class="main" style="color:black">
			<b>Traveling times</b><br><br>
			It’s easy to underestimate traveling times in India. Distances may seem short on paper, but Indian roads may
			be narrower than you’re used to.<br><br>
		</p>
		<p class="main" style="color:black">
		<ul style="list-style: circle;">
			...
			<li style="display:list-item;">If you begin to feel sleepy, stop at a safe place and try to have a short
				sleep for up to 40 minutes.</li>
			<li style="display:list-item;">If you’re feeling very tired, find a place to stay overnight.</li>
		</ul>
		</p><br><br>
		<p class="main" style="color:black">
			<b>Overtaking</b><br><br>
			Most roads in India have a single lane each way, and some provide passing lanes at regular intervals – these
			should be used where possible when overtaking. You must not cross a solid yellow line on your side of the
			center
	...
	<div class="ccr1">
		...
		<p class="main" style="color:blackl;margin-left:2%;">
			<b>Rental wheels provides selfdriven car in Delhi/NCR India. Selfdriven concept has been highly developed in
				India as it quite new concept as well.</b><br><br>
			<b>Selfdriven concept is like enjoying a journey rather than reaching a destination.</b><br><br>
			<b>In other words, it is the concept of learning and feeling the nature vibes.</b><br><br>
			Driving in India should be a safe and enjoyable experience. If you have never driven in India before you
		...
		<p class="main" style="color:black;margin-left:2%;">
			Contact
			<br><br><b>
				Phone Number:<font color="#00afe5"> +91</font> 1234
				<br><br>
				Email Address:<font color="#00afe5"> info@Rental.in</font>
				<br><br>
				Reservation Hours: Monday to Sunday 24 hours</b>
		</p><br><br>
	</div>
	<footer>
		...
		<table>
			...
			<tr bgcolor="#252525">
				<td class="widget">
					<p class="text">Rental wheels is one of the reputed Travel<br>
						Company in India.<br>
				...
				<td class="widget">
					<p class="text1">Address: Tamil Nadu,India<br>
						<img src="images/phone.png">&emsp;+91-123<br>
						<img src="images/message.png">&emsp;rental@gmail.com
					</p>
				</td>
			</tr>
			<tr bgcolor="black">
