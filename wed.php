...
<body>
	<header>
		...
		<div class="head">
			...
			<br>
			<font> We have been known in industry for our 100% customer satisfaction</font>
		</div>
	</header>
	<br> <br> <br>
	...
	<div class="break"><img src="images/marry.jpg" style="width:70%;margin-left:10%;margin-right:10%;margin-top:1%;"
			align="left"><br></div>
	<script>
	...
	<div class="ccr">
		...
		<p style="color:grey;font-size:95%;text-align:left;margin:2% 80px 0 50%;">
			We have been known in the industry for our 100% customer satisfaction.<br>
			We provide cars on rent for business promotions, corporate meetings, wedding, and movies, etc.
			we have a wide range of luxury and premium cars for you. We think for a special occasion we need the right
			car at right prices.
		</p>
		<p style="font-size:95%;text-align:left;margin:10% 0 10% 4%;">
			We assured you the best of our services. Further for more assistance please feel free to call us – 123.<br>
			<b>
				<font color="#00afe5">Wedding Car On Rent.</font>
			</b>
		</p>
	</div>
	<div class="ccr1">
		...
		<p style="color:grey;font-size:90%px;text-align:left;margin-left:2%;">
			..</b> We have been known in the industry for our 100% customer satisfaction.<br>
			We provide cars on rent for business promotions, corporate meetings, wedding, and movies, etc.
			we have a wide range of luxury and premium cars for you. We think for a special occasion we need the right
			car at right prices.
	...
	<footer>
		...
		<table>
			...
			<tr bgcolor="#252525">
				<td class="widget">
					<p class="text"> one of the reputed Travel<br>
						Company in India.<br>
