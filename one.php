...
<body>
	<header>
		<div class="up" id="up">
			<div class="logo"><img src="images/lgo.jpeg" height="100%" width="10%%"
				...
				<font style="font-size:1.254vw;">&ensp;+91-123456789&emsp;</font>
		...
		<div class="head">
			...
			<br>
			<font> customer friendly company where customer service and satisfaction come first.</font>
		</div>
	</header>
	<br><br><br>
	...
	<div class="break"><img src="images/oneway.jpg" height="auto" width="80%" align="left"
			style="margin-left:10%;"><br><br></div>
	<script>
	...
	<div class="ccr">
		...
		<p class="main" style="margin:2% 7% 0 52%;line-height:2.5;">
			We offer to make it easy for clients to get the right car at
			the right price at the right time. If you are looking for car rental service in Delhi/India or minibusses
			hire services For One
			Way Drop, Book cheap budget One Way Car
		</p><br><br>
		<p class="main" style="color:black;margin-left:3%;">
			...
			Just take a back seat and let our professional chauffeur takes you to wherever you want to go. No more
			worries about traffic
			congestion or parking, our drive service will get you to your destination relax and on-time.
		</p><br>
		<p class="main" style="color:black;margin-left:3%;">
			<b>Advantages</b><br>
		<ul style="list-style: circle;margin-left:30px;">
			<li style="display:list-item;">Professional English-talking driver who will meet and escort you to the auto
				without issue</li><br>
			<li style="display:list-item;;">High-Quality extravagance aerated and cooled and non-smoking vehicles</li>
			<br>
			<li style="display:list-item;;">Flexible rental bundles accessible for air terminal/lodging exchange, Point
				A to B exchanges,
		...
		<p class="main" style="color:black;margin-left:3%;">
			...
			The driver will meet you at the airplane terminal, office, eatery, inn or home. There is no compelling
			reason to design your excursion.
