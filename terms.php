...
<body>
	<header>
		<div class="up" id="up">
			<div class="logo"><img src="images/lgo.jpeg" height="100%" width="10%%"
				...
				<font style="font-size:1.254vw;">&ensp;Info@RentalS.in</font>
			</div>
			<div class="logo1">
	...
	<ol style="margin:3% 0 3% 3%;list-style-type: decimal;color: #808080;">
		...
		<li>The customer agrees and accept that the use of the services given by Rental Wheels is at the sole risk of
			the
		...
		<li>Soiling and damaging the seats and any other interior of the vehicle, charges will be given by the customer
			for that.</li>
		<li>Asking the chauffeur to break any traffic/RTO or government rule for any purpose (especially reaching the
			destination earlier) then the driver has the rights to refuse such these types of requests.</li>
		<li>The trip will be done accordingly to your mentioned itinerary. If you want to visit some other locations so
			the customer has to pay additionally.</li>
		<li>By any chance, if your flight or train or bus misses wheelzonrent will not be liable for that.</li>
	</ol>
	<p style="margin:5% 0 5% 2%;">The above-mentioned terms and conditions of use and the Privacy Policy constitute the
		entire agreement between the
		User(s) and Rental Wheels with respect to access to and use of the website and the Services offered by Rental
		Wheels,
