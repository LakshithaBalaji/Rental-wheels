...
<head>
	...
	<style>
		...
		.dropdown:hover {
			background-color: #ff004f color: #00afe5;
		}
...
<body onload="Display()">
	<header>
		<div class="up" id="up">
			...
			<font style="font-size:1.254vw;">&ensp;+91-12456789&emsp;</font>
	...
	<iframe
		src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d125042.27043239014!2d78.05589508853711!3d11.653891509588464!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3babf1ccf52cba0b%3A0xee9989007068ca47!2sSalem%2C%20Tamil%20Nadu!5e0!3m2!1sen!2sin!4v1699200136941!5m2!1sen!2sin"
		width="1500" height="250" style="border:0;" allowfullscreen="" loading="lazy"
	...
	<form method="post" enctype="multipart/form-data" autocomplete="on">
		<table class="form" id="registration">
			...
			<tr>
				<td>Vehicle Type:&nbsp;<select name="vehicle_type" id="display11" style="width:60%;">
			...
			<tr>
				<td>Vehicle Name:&nbsp;<select name="vehicle" id="display1" style="width:60%;">
						<option value="">Select Vehicle</option>
		...
		<table class="form">
			...
			<tr>
				<td colspan="2"><input id="Sub" type="submit" name="submit" value="Book Now" onclick="DATE()">
				</td>
			</tr>
	</form>
	</table>
			...
			<tr bgcolor="#252525">
				...
				<td class="widget">
					<p class="text1">Address: Tamil Nadu,India<br>
						<img src="images/phone.png">&emsp;+91-12456789<br>
	...
	if (isset($_POST["submit"]) && !empty("$_POST[name]")) {
		...
		if ($i == $rowsnum) {
			...
			$sql = "INSERT INTO package(Name,Email,Phone,Message,Subject,Vehicle,VehicleType,Amount,Date,License) VALUES ('$_POST[name]','$_POST[email]','$_POST[phone]','$_POST[message]','$_POST[subject]','$_POST[vehicle]','$_POST[vehicle_type]','$_POST[amount]','$_POST[date]','{$image}')";

			if (!mysqli_query($conn, $sql)) {
				echo "Error: " . $sql . "<br>" . htmlspecialchars(mysqli_error($conn));
			}

			echo '<script>Location();  alert("The vehicle is booked on the corresponding date.Proceed to the payment process"); ClearTable();
			             </script>';
		} else {
